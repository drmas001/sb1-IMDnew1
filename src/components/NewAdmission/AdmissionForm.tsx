...
const safetyTypes = [
  { id: 'emergency', label: 'Safety Admission - Emergency', color: 'red' },
  { id: 'observation', label: 'Safety Admission - Observation', color: 'yellow' },
  { id: 'short-stay', label: 'Safety Admission - Short Stay', color: 'green' }
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-600 focus:border-transparent"
          >
            <option value="">No Safety Admission</option>
